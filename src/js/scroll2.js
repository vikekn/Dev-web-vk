...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const url = `${location.origin}/registro`;

    if (urlActual === url) {
        // Obtener el enlace de Iniciar Sesión
        var enlaceInicioSesion = document.querySelector('.header__enlace[href="/registro"]');
        ...
        var clicEnlaceInicioSesion = function(event) {
            ...
            var inicioSesionElement = document.getElementById('registroSession');
